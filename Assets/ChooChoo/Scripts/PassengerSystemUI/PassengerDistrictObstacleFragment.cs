...
namespace ChooChoo
{
  internal class PassengerDistrictObstacleFragment : IEntityPanelFragment
  {
    ...
    public VisualElement InitializeFragment()
    {
      _root = _uiBuilder.CreateFragmentBuilder()
        ...
        .AddComponent(builder => builder
          ...
          .SetWidth(new Length(100, LengthUnit.Percent))
          .SetJustifyContent(Justify.Center)
          .AddPreset(builder => builder.Labels().GameText(name: "CollidingSectionDividerWarningLabel", locKey: "Tobbert.PassengerStation.DistrictObject")))
    ...
    public void ShowFragment(BaseComponent entity)
    {
      ...
      if (!(bool)(Object)_passengerStationDistrictObject || !_passengerStationDistrictObject.enabled) 
        return;
