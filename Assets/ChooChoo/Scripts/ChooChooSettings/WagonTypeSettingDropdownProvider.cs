...
namespace ChooChoo
{
    public class WagonTypeSettingDropdownProvider : IExtendedDropdownProvider, ILoadableSingleton
    {
        ...
        public void Load()
        {
            Items = new[] { "Tobbert.WagonModel.BoxWagon", "Tobbert.WagonModel.TankWagon", "Tobbert.WagonModel.FlatWagon", "Tobbert.WagonModel.FlipperWagon", "Tobbert.WagonModel.MetalCart" };
        }
