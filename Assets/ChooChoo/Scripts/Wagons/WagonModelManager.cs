...
namespace ChooChoo
{
    public class WagonModelManager : MonoBehaviour, IPersistentEntity
    {
        ...
        private void InitializeModels()
        {
            ...
            {
                var model = ChooChooCore.FindBodyPart(transform, wagonModelSpecification.ModelLocation.Split("/").Last()).gameObject;
