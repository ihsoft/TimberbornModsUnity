...
namespace ChooChoo
{
  public class TrainBatchControlRowItemFactory
  {
    ...
    public IBatchControlRowItem Create(GameObject entity)
    {
      ...
      //   return null;
      VisualElement visualElement = _visualElementLoader.LoadVisualElement("Master/BatchControl/MechanicalBatchControlRowItem");
    ...
    {
      VisualElement visualElement = _visualElementLoader.LoadVisualElement("Master/BatchControl/MechanicalHeaderBatchControlRowItem");
