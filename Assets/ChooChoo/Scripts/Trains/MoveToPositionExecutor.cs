...
namespace ChooChoo
{
  public class MoveToPositionExecutor : MonoBehaviour, IExecutor
  {
    ...
    public ExecutorStatus Launch(Vector3 position) => _machinist.GoTo(_trainPositionDestinationFactory.Create(position));
