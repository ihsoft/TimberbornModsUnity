...
namespace  ChooChoo
{
  public class TrackFollowerFactory
  {
    ...
    public TrackFollowerFactory(INavigationService navigationService, TrainNavigationService trainNavigationService, TrackSectionService trackSectionService) 
    {
