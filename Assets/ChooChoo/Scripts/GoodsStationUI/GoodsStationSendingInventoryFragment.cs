...
namespace ChooChoo
{
  internal class GoodsStationSendingInventoryFragment : IEntityPanelFragment
  {
    ...
    public GoodsStationSendingInventoryFragment(
    ...
    public void ShowFragment(BaseComponent entity)
    {
      ...
      _inventoryFragment.ShowFragment(_goodsStation.SendingInventory);
    }
